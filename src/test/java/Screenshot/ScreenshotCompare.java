...
public class ScreenshotCompare {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String SiteLevel1 = "17Nov";
        String SiteLevel2 = "18Nov";
        String ScreenshotThrough = "Stack";
        String Site = "HCL";
        String SitePath = "C:\\Users\\innoraft\\Downloads\\TestingFiles\\Screenshots\\" + Site + "\\";
...
//        func.ChangeWidth(SiteLevel1, SiteLevel2, ScreenshotThrough, SitePath);
        ...
        Process p = null;
        String Config_Path = "C:\\wraith\\";
        String Config_File = Config_Path + "configs\\config.yaml";
