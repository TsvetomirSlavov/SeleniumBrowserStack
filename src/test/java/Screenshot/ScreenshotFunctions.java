...
public class ScreenshotFunctions {
    ...
    public String BasePath = "C:\\Users\\innoraft\\Downloads\\";
    private WebDriver driver;
    private WebDriverWait wait;
    private int timeoutOfOneElement = 900;
    private int timeoutOFAllElement = 20;
    private String ChromeDriverPath = "C:\\Users\\innoraft\\Downloads\\chromedriver_win32\\chromedriver.exe";
    private String IEDriverPath = "C:\\Users\\innoraft\\Downloads\\IEDriverServer_x64_2.53.1\\IEDriverServer.exe";
    ...
    private void CutPasteFiles(String Filename, String Path, String Structure, String SiteLevel) throws IOException, InterruptedException {
        ...
        for (int i = 0 ; i < ListOfFiles.length ; i++){
            ...
            if (Structure == "Single") {
                ...
                Path Destination = Paths.get(BasePath + "/" + Path + "/" + ListOfFiles[i].getName());
                ...
                String OS_Browser = SplitFilename[0];
