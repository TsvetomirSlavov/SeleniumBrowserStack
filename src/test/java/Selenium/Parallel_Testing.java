...
public class Parallel_Testing {
    ...
    public void testFirst(String browser) throws Exception {
        if(browser.equalsIgnoreCase("internet explorer")) {
            System.setProperty("webdriver.ie.driver", "C:\\Users\\innoraft\\Downloads\\IEDriverServer_x64_2.53.1\\IEDriverServer.exe");
            driver = new InternetExplorerDriver();
        }
        else if (browser.equalsIgnoreCase("chrome")){
            System.setProperty("webdriver.chrome.driver", "C:\\Users\\innoraft\\Downloads\\chromedriver_win32\\chromedriver.exe");
